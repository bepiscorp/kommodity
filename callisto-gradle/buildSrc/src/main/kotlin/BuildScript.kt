...
val SourceSet.kotlin: SourceDirectorySet
    get() = (this as org.gradle.api.internal.HasConvention)
        .convention
 ...
 * @see <a href="https://github.com/JetBrains/kotlin/blob/v1.2.20/buildSrc/src/main/kotlin/sourceSets.kt#L45-L54">sourceSets.kt</a>
 */
fun SourceSet.kotlin(action: SourceDirectorySet.() -> Unit): Unit = kotlin.action()

/**
 * @see <a href="file://.../gradle-kotlin-dsl-accessors/.../src/org/gradle/kotlin/dsl/accessors.kt">Generated code</a>
 */
val Project.java: JavaPluginExtension get() = this.extensions.getByName<JavaPluginExtension>("java")

val Project.base: BasePluginExtension get() = this.extensions.getByName<BasePluginExtension>("base")

val Project.gradlePlugin: GradlePluginDevelopmentExtension get() = this.extensions.getByName<GradlePluginDevelopmentExtension>("gradlePlugin")
...
/**
 * Alternative solution: [StackOverflow#64825340](https://stackoverflow.com/a/64825340/253468)
 */
...
fun DependencyHandler.gradleApiWithoutKotlin(): Dependency = withoutKotlin(ClassPathNotation.GRADLE_API)

fun DependencyHandler.gradleKotlinDslWithoutKotlin(): Dependency = withoutKotlin(ClassPathNotation.GRADLE_KOTLIN_DSL)

fun DependencyHandler.gradleTestKitWithoutKotlin(): Dependency = withoutKotlin(ClassPathNotation.GRADLE_TEST_KIT)
 ...
 */
private class StaticComponentIdentifier(private val displayName: String) : ComponentIdentifier {
