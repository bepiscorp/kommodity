 ...
 */
@InternalLibraryApi
public class IncludeAllSchemaTyrellChangelogFilter : AbstractIncludeAllTyrellChangelogFilter() {
    ...
    private companion object {
        ...
        private val SCHEMA_CHANGELOG_FILENAME_REGEX: Regex = Regex("^(.+-)*schema.changelog.xml$")

        private val SCHEMA_SQL_CHANGELOG_FILENAME_REGEX: Regex = Regex("^(.+-)*schema.changelog.sql$")
